...
Запуск сервлета целиком — один клик, логи стримятся в реальном времени по WebSocket, результат готов к скачиванию:

![Демо Workbench](docs/demo.gif)
...
Страница сервлета с живыми логами:
